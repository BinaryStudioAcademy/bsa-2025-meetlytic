...
sudo apt-get install -y ffmpeg pulseaudio pulseaudio-utils libatk1.0-0 libatk-bridge2.0-0 libgtk-3-0 libappindicator3-1 libnss3 libxss1 libasound2 libgbm1 libx11-xcb1 libxcomposite1 libxkbcommon0
