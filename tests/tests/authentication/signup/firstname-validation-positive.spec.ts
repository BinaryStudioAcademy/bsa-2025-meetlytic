...
test.describe("First Name Validation - Positive Cases", () => {
	test("Register with a valid first name", async () => {
		...
		const baseUser = generateFakeUser(); // Register with a valid FirstName
	...
	test("Register with a single-character first name", async () => {
		...
		const singleCharFirstName = generateFakeUser(
			{},
			{ singleCharFirstName: true },
			{},
		); // Register with a singleCharFirstName FirstName
	...
	test("Remove trailing/leading whitespaces from FirstName field", async () => {
		const withSpacesFirstName = generateFakeUser(
			{},
			{ withSpacesFirstName: true },
			{},
		); // Register with a withSpacesFirstName FirstName
	...
	test("Hyphen in Firstname", async () => {
		// generate single-char first name
		const withHyphenFirstName = generateFakeUser(
			{},
			{ withHyphenFirstName: true },
			{},
		); // Register with a withHyphenFirstName FirstName
	...
	test("Fifty letters in Firstname", async () => {
		// generate single-char first name
		const fiftyLetterFirstName = generateFakeUser(
			{},
			{ fiftyLetterFirstName: true },
			{},
		); // Register with a fiftyLetterFirstName FirstName
